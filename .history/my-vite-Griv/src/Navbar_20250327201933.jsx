...
const Navbar = () => {
  ...
  return (
    <motion.nav 
      ...
      className="fixed w-full z-50 bg-gradient-to-r from-emerald-600 to-emerald-800 text-lime-500 shadow-2xl"
    >
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        >
          ...
          >
            <span className="bg-white text-lime-600 px-2 rounded-md">G</span>
            ...
            >
              <Link 
                ...
                className={`
                  ...
                  ${item.special 
                    ? 'bg-white text-lime-600 px-4 py-2 rounded-full' 
                    : 'text-white hover:text-lime200'}
