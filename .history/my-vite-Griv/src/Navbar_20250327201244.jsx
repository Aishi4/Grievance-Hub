      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          ...
          >
            <Link
              to="/login"
              className="flex items-center space-x-2 bg-white text-lime-700 px-4 py-2 rounded-full font-semibold shadow-md hover:bg-emerald-50 transition-all duration-300"
            >
              <LogIn size={20} />
              <span>Login</span>
            </Link>
