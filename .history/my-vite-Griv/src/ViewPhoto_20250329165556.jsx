...
export default function ViewPhoto() {
  ...
  const statusColors = {
    ...
    return (
    <div className="h-screen w-screen bg-white to-purple-900 flex items-center justify-center p-6">
        ...
        <div className="mb-4">
          ...
          <div className="flex">
            <input 
              ...
              className="flex-1 p-3 border border-gray-300 rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:outline-none text-bla"
            />
            <button 
              onClick={fetchPhoto} 
              disabled={isLoading} 
      ...
      {photo && (
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            <span className={`px-4 py-2 text-sm font-medium text-white rounded-full ${statusColors[photo.status] || 'bg-gray-500'}`}>
              {photo.status}
            </span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <img src={photo.image_url} alt="Grievance" className="w-full h-64 object-cover rounded-lg border border-gray-300" />
