...
import emptyAnimation from './assets/search.json'; // Ensure you have a Lottie JSON file
...
export default function ViewPhoto() {
  ...
  return (
      <div className="h-screen w-screen bg-gradient-to-b from-green-50 to-green-100 flex items-center justify-center p-6">
