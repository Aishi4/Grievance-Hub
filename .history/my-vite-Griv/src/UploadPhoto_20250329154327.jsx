...
export default function UploadPhoto() {
  ...
  return (
    <div className="min-h-screen min-w-screen flex items-center justify-center bg-[#f8f8f8] p-4">
      <div className="  bg-white p-8 rounded-lg shadow-xl border border-gray-300 text-center">
