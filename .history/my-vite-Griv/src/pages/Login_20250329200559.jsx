...
import loginAnimation from "../assets/Us.json";
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen min-w-screen flex justify-center items-center min-h-screen bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-800 p-4">
      {/* Decorative elements */}
      ...
      <motion.div 
        ...
        className="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row"
      >
        {/* Left side - Animation */}
        <motion.div 
