...
const Home = () => {
  return (
    <div className="min-h-screen min bg-gradient-to-b from-green-50 to-green-100 flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden">
      {/* Decorative Elements */}
