...
const Login = () => {
  ...
  return (
    <div className="min-h-screen min-w-screenflex justify-center items-center min-h-screen bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-800 p-4">
      {/* Decorative elements */}
